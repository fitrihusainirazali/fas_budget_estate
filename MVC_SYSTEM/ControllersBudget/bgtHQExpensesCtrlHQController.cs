...
namespace MVC_SYSTEM.ControllersBudget
{
    ...
    public class bgtHQExpensesCtrlHQController : Controller
    {
        ...
        public ActionResult Index(string BudgetYear = null)
        {
            ...
            var RoleScreen = UserMatrix.RoleScreen(userid, "E5");
            if (!RoleScreen.view)
            {
        ...
        {
            int? totalCount = dbe.bgt_expenses_CtrlHQ
                .Where(i => i.abhq_budgeting_year == selectedYear).Count();
            return totalCount == 0;
        }
        ...
        private List<ExpensesHQListDetailViewModel> GetRecordsDetail(int? BudgetYear = null, string CostCenter = null, int? Version = null, int? Page = null, int? PageSize = null)
        {
            ...
            var query = from i in dbe.bgt_expenses_CtrlHQ
                        where !i.abhq_Deleted && cccode.Contains(i.abhq_cost_center)
                        select i;
            //end fitri
            if (BudgetYear.HasValue)
            {
            ...
            var query3 = (from q in query2.AsEnumerable()
                          select new ExpensesHQListDetailViewModel
                          {
                              ...
                              CostCenterCode = q.abhq_cost_center,
                ...
                using (var stream = file.InputStream)
                {
                    ...
                    try
                    {
                        ...
                        if (headerRow != null)
                        {
                            ...
                            int? currentVersion = dbe.bgt_expenses_CtrlHQ
                                .Where(i => i.abhq_budgeting_year == BudgetYear).Max(x => x.abhq_version);
                                        ...
                                        if (cell != null)
                                        {
                                            ...
                                            if (!string.IsNullOrEmpty(ccCode) && !string.IsNullOrEmpty(glCode))
                                            {
                                                var expenses_hq = new bgt_expenses_CtrlHQ
                                                {
                                                    ...
                                                    abhq_cost_center_name = cc.GetCostCenterDesc(ccCode.PadLeft(10, '0')),
                                                    abhq_gl_code = glCode,
        ...
        public async Task<ActionResult> UpdateProration(string BudgetYear, string CostCenter = null, string ProductActivity = null, string Station = null, string Views = null, string Option = null, string Version = "1")
        {
            ...
            if (!string.IsNullOrEmpty(BudgetYear) && !string.IsNullOrEmpty(CostCenter))
            {
                ...
                var expensesHQ = dbe.bgt_expenses_CtrlHQ
                    .Where(i => i.abhq_budgeting_year == year && i.abhq_cost_center.Contains(CostCenter) && i.abhq_version == version)
                    .ToList();
                if (expensesHQ.Count > 0)
                {
                    for (int i = 0; i < expensesHQ.Count; i++)
                    {
                        var totalAmount = expensesHQ[i].abhq_jumlah_keseluruhan ?? 0;
                        ...
                        if (Views.Equals("monthly", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            expensesHQ[i].abhq_proration = Views;
                            expensesHQ[i].abhq_month_1 = monthlyAmount;
                            expensesHQ[i].abhq_month_2 = monthlyAmount;
                            expensesHQ[i].abhq_month_3 = monthlyAmount;
                            expensesHQ[i].abhq_month_4 = monthlyAmount;
                            expensesHQ[i].abhq_month_5 = monthlyAmount;
                            expensesHQ[i].abhq_month_6 = monthlyAmount;
                            expensesHQ[i].abhq_month_7 = monthlyAmount;
                            expensesHQ[i].abhq_month_8 = monthlyAmount;
                            expensesHQ[i].abhq_month_9 = monthlyAmount;
                            expensesHQ[i].abhq_month_10 = monthlyAmount;
                            expensesHQ[i].abhq_month_11 = monthlyAmount;
                            expensesHQ[i].abhq_month_12 = monthLastAmount;
                        ...
                        else if (Views.Equals("quarterly", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            expensesHQ[i].abhq_proration = Views;
                            expensesHQ[i].abhq_month_1 = 0;
                            expensesHQ[i].abhq_month_2 = 0;
                            expensesHQ[i].abhq_month_3 = monthlyAmount;
                            expensesHQ[i].abhq_month_4 = 0;
                            expensesHQ[i].abhq_month_5 = 0;
                            expensesHQ[i].abhq_month_6 = monthlyAmount;
                            expensesHQ[i].abhq_month_7 = 0;
                            expensesHQ[i].abhq_month_8 = 0;
                            expensesHQ[i].abhq_month_9 = monthlyAmount;
                            expensesHQ[i].abhq_month_10 = 0;
                            expensesHQ[i].abhq_month_11 = 0;
                            expensesHQ[i].abhq_month_12 = monthLastAmount;
                            expensesHQ[i].last_modified = DateTime.Now.ToLocalDateTime();
                            dbe.Entry(expensesHQ[i]).State = EntityState.Modified;
                        }
                        else if (Views.Equals("semiannually", StringComparison.OrdinalIgnoreCase))
                        {
                            ...
                            expensesHQ[i].abhq_month_1 = 0;
                            expensesHQ[i].abhq_month_2 = 0;
                            expensesHQ[i].abhq_month_3 = 0;
                            expensesHQ[i].abhq_month_4 = 0;
                            expensesHQ[i].abhq_month_5 = 0;
                            expensesHQ[i].abhq_month_6 = monthlyAmount;
                            expensesHQ[i].abhq_month_7 = 0;
                            expensesHQ[i].abhq_month_8 = 0;
                            expensesHQ[i].abhq_month_9 = 0;
                            expensesHQ[i].abhq_month_10 = 0;
                            expensesHQ[i].abhq_month_11 = 0;
                            expensesHQ[i].abhq_month_12 = monthLastAmount;
                            expensesHQ[i].last_modified = DateTime.Now.ToLocalDateTime();
        ...
        private DateTime GetFirstUploadDate(int year, string uploadedBy, int version)
        {
            ...
            if (data != null)
            {
                return data.abhq_upload_date ?? DateTime.Now.ToLocalDateTime(); //DateTime.Now;
            }
